...
with the internals of the GPS directly; (s)he simply wants to tell it to "go_home"! At runtime, all of the widgets
contribute their own high-level functionality to produce a very powerful DSL.
